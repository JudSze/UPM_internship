...
# ncp.max is the maximum number of components to test, I would recommend using the number of columns as the value for this parameter
nb = estim_ncpPCA(expression, method.cv = "Kfold", ncp.min = 0, ncp.max = 15, verbose = FALSE)
nb$ncp # note the recommended dimension
